...
import NewFileComponentModal from "../NewFileComponentModal/NewFileComponentModal.jsx"
...
const NewFileModal = ({ open, onClose }) => {
  ...
  const handleOpen = () => serOpenModal(true);

  const handleClose = () => serOpenModal(false);
  ...
  return (
    <>
      ...
      <NewFileComponentModal open={openModal} onClose={handleClose} />
    </>
  );
};
